...
public class RequestServiceImpl implements RequestService {
    ...
    public ParticipationRequestDto create(Long userId, Long eventId) {
        ...
        Event event = eventRepository
                .findById(eventId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Event not found."));
    ...
    public EventRequestStatusUpdateResult updateStatusRequests(Long userId, Long eventId, EventRequestStatusUpdateRequest request) {
        ...
        List<ParticipationRequest> requests = requestRepository.findAllByEventIdAndIdIn(eventId, request.getRequestIds())
                .stream()
                .peek(req -> {
